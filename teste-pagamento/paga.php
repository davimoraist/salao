...
/* =======================================================
   3. CADASTRO AUTOMÁTICO DO CLIENTE NO ASAAS
======================================================= */
$clienteId = cadastrarClienteNoAsaas($nomeCliente, $cpfCliente, $apiKey);
...
if (isset($dadosPagamento['id']) && !isset($dadosPagamento['errors'])) {
    ...
    http_response_code(400);
    echo json_encode([
        "error" => "Não foi possível gerar a cobrança no Asaas.", 
        "detalhes" => $dadosPagamento['errors'] ?? $dadosPagamento
    ]);
}
...
function cadastrarClienteNoAsaas($nome, $cpf, $apiKey) {
